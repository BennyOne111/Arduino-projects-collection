// Half-Step Motor Control with button, one full circle per push of button
// Author: Yiyang Jiang
...
// The number of increments per step, half step
const int INCREMENTSPERSTEP = 2;  
...
void loop() {
  ...
  // Move forward 12 steps(360/3.75/8), each step includes 8 increment, each increment represents 3.75 degree
